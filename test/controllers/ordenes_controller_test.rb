...
class OrdenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ordene" do
    assert_difference('Ordene.count') do
      post ordenes_url, params: { ordene: { clientes_id: @ordene.clientes_id, fecha: @ordene.fecha, numero_orden: @ordene.numero_orden } }
    end
  ...
  test "should update ordene" do
    patch ordene_url(@ordene), params: { ordene: { clientes_id: @ordene.clientes_id, fecha: @ordene.fecha, numero_orden: @ordene.numero_orden } }
