...
class DetalleOrdenesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle_ordene" do
    assert_difference('DetalleOrdene.count') do
      post detalle_ordenes_url, params: { detalle_ordene: { cantidad: @detalle_ordene.cantidad, precio_venta: @detalle_ordene.precio_venta, productos_id: @detalle_ordene.productos_id } }
    end
  ...
  test "should update detalle_ordene" do
    patch detalle_ordene_url(@detalle_ordene), params: { detalle_ordene: { cantidad: @detalle_ordene.cantidad, precio_venta: @detalle_ordene.precio_venta, productos_id: @detalle_ordene.productos_id } }
