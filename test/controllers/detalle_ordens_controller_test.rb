...
class DetalleOrdensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detalle_orden" do
    assert_difference('DetalleOrden.count') do
      post detalle_ordens_url, params: { detalle_orden: { cantidad: @detalle_orden.cantidad, precio_venta: @detalle_orden.precio_venta, producto_id: @detalle_orden.producto_id } }
    end
  ...
  test "should update detalle_orden" do
    patch detalle_orden_url(@detalle_orden), params: { detalle_orden: { cantidad: @detalle_orden.cantidad, precio_venta: @detalle_orden.precio_venta, producto_id: @detalle_orden.producto_id } }
